...
class TransactionList extends StatelessWidget {
  final List<Transaction>
      transactions; //a list to receive the list of transactions

  final Function
      deleteTx; //receives deleteTransaction Function from main.dart file
  TransactionList(this.transactions,
      this.deleteTx); //initializes the list, 'transactions' when instantiated

  @override
  Widget build(BuildContext context) {
    return transactions.isEmpty
        ? LayoutBuilder(builder: (LBcontext, constraint) {
            return Column(
